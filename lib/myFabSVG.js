...
function SVGInstance(elmID){
  ...
  rect1move_elm.addEventListener('click', () => {this.rect1move_actrl();} ); // Important, use arrow function to wrap the eventlistner callback (as above), so that when it is invoked the 'this' will refer to the SVGInstance object and not to the DOM object on which the event occurred (eg a button)
